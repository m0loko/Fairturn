...
- Один из участников группы или подгруппы создает веб-таблицу в [Google Таблицах](https://docs.google.com/spreadsheets) и предоставляет доступ для редактирования всем, у кого есть ссылка.
...
- **Рандомизация меса при равных баллах** *(новое)* — при равном количестве баллов у нескольких человек программа распределяет их места в случайном порядке.
  - Распределение в таком случае работает на основе генератора псевдослучайных чисел с уникальным сидом при каждом запуске(что гарантирует случайность). Больше место не зависит от вашей фамилии. Госпожа Фартуна сама решит. 
---
